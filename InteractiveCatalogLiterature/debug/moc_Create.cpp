...
const QMetaObjectExtraData Create::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Create::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Create,
      qt_meta_data_Create, &staticMetaObjectExtraData }
};
...
void *Create::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Create"))
        return static_cast< Ui::Create*>(const_cast< Create*>(this));
